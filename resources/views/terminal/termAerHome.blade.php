            ...
            {{-- <div class="card-header-right">
                ...
                <form class="form-inline">
                    <button type="button" class="btn btn-primary mb-2" id="btn_new_terminal"
                        onclick="$('#form_new_terminal').trigger('reset');$('#mod_new_terminal').modal('show'); ">Listar
                        <i class="fa fa-stopwatch"></i></button>
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="forms-sample" id="form_new_terminal"
                    onsubmit="event.preventDefault(); createTerm(this.id);">@csrf
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <span>Nombre</span>
                                <input type="text" class="form-control" name="t_nombre" id="t_nombre"
