        ...
        <div class="card-header">
            ...
            <div class="card-header-right">
                ...
                <form class="form-inline">
                    ...
                    <button type="button" class="btn btn-primary mb-2" id="btn_new_empresa">Nuevo <i
...
<div class="modal fade" id="mod_new_empresa" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel"
    aria-hidden="true">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <span>Nombre</span>
                                <input type="text" class="form-control" name="Emp_nombre" maxlength="150"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="Emp_abreviacion" maxlength="5"
                                    autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <span>Telefono</span>
                                <input type="text" class="form-control" name="Emp_telf" maxlength="25"
                                    autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                <span>Dirección</span>
                                <input type="text" class="form-control" name="Emp_dir" maxlength="150"
                                    autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="Emp_repLeg" maxlength="50"
                                    autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <span>Casilla</span>
                                <input type="text" class="form-control" name="Emp_casi" maxlength="25"
                                    autocomplete="off">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <span>Fax</span>
                                <input type="text" class="form-control" name="Emp_fax" maxlength="25"
                                    autocomplete="off">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <span>Email</span>
                                <input type="text" class="form-control" name="Emp_email" maxlength="100"
                                    autocomplete="off">
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <span>Ruc</span>
                                <input type="text" class="form-control" name="Emp_ruc" maxlength="15"
                                    autocomplete="off">
                            </div>
                        </div>
                    </div>
...
<!-- modal delete users -->
<div class="modal fade" id="md_empreaDelete" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-sm " role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <p>
                    Si desea Elimar el previo registro de empresa, debe seleccionar la empresa destino de los empleados
                    ya registrardos en sistema.
                </p>

                <select class=" form-control" id="listEmpresaSel">
                    @foreach ($Emps as $emp)
                        <option value="{{ $emp->id }}">{{ $emp->Empresa }} |
                            @if ($emp->Estado=='M')
                                VVI
                            @endif
                            @if ($emp->Estado=='A')
